---
title: "Send Email in C# via SMTP (MailKit)"
sidebarTitle: "C# / .NET"
description: "Send email from C# and .NET through AhaSend's SMTP relay with MailKit, and why System.Net.Mail SmtpClient fails AUTH over STARTTLS. HTML, attachments, headers."
icon: "microsoft"
---
...
Use the exact version installed by `dotnet add package MailKit` in your project file:

```xml PackageReference
<PackageReference Include="MailKit" Version="YOUR_INSTALLED_VERSION" />
```

```text Package Manager UI
    ...
    static void Main()
    {
        using (var client = new SmtpClient())
        {
            try
            {
                ...
                message.Headers.Add("AhaSend-Metadata-Retention", "30");
                message.Headers.Add("AhaSend-Data-Retention", "7");
