---
title: "Send Email in PHP via SMTP (PHPMailer, Laravel)"
sidebarTitle: "PHP"
description: "Send email from PHP through the AhaSend SMTP relay with PHPMailer, Symfony Mailer or Laravel: STARTTLS settings, attachments and sandbox tests."
icon: "php"
---
...
The next block continues the basic PHPMailer example and uses its imports.
...
For framework setup, use [Symfony](/guides/symfony) or [Laravel](/guides/laravel). Existing HTTP API integrations have their own [WordPress plugin](/guides/wordpress) and [Drupal module](/guides/drupal) guides.
