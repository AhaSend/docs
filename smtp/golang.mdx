---
title: "Send Email in Go via SMTP (net/smtp, gomail)"
sidebarTitle: "Go"
description: "Send email from Go through AhaSend's SMTP relay using net/smtp or gomail: STARTTLS on port 587, HTML, attachments, custom headers, retries and sandbox testing."
icon: "golang"
---
...
func main() {
    ...
    m.SetHeader("AhaSend-Metadata-Retention", "14")
    m.SetHeader("AhaSend-Data-Retention", "3")
