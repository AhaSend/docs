---
title: "Create SMTP Credentials (Username and Password)"
sidebarTitle: "SMTP Credentials"
description: "Create an AhaSend SMTP username and password in the dashboard or API, choose production or sandbox mode and domain scope, and fix SMTP authentication errors."
icon: "key"
---
...
<AccordionGroup>
  <Accordion title="Authentication Failed" icon="triangle-exclamation">
    Newly created credentials can take up to 2 minutes to reach every SMTP server. Wait before retrying a new credential.
    **Common causes:**
    - Incorrect username or password
    - Using your dashboard login instead of SMTP credentials
    - Credentials not created or revoked
...
<CardGroup cols={2}>
  <Card title="Configure Sandbox Mode" icon="flask" href="/send-api/sandbox">
...
- [Domain setup](/domains), [SMTP settings](/smtp), [Special headers](/smtp/special-headers).
