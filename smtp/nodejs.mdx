---
title: "Send Email in Node.js via SMTP (Nodemailer)"
sidebarTitle: "Node.js"
description: "Send email from Node.js with Nodemailer and the AhaSend SMTP relay: STARTTLS on port 587, HTML, attachments, env vars and sandbox testing."
icon: "node-js"
---
...
for (const name of ['SMTP_USERNAME', 'SMTP_PASSWORD', 'FROM_EMAIL']) {
...
const mailOptions = {
    from: { name: process.env.FROM_NAME || "Your Company", address: process.env.FROM_EMAIL },
    to: 'user@example.com',
