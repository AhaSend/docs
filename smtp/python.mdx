---
title: "Send Email in Python via SMTP (smtplib)"
sidebarTitle: "Python"
description: "Send email from Python with smtplib and AhaSend's SMTP relay: STARTTLS on port 587, HTML and plain-text messages, attachments, custom headers and sandbox tests."
icon: "python"
---
...
<AccordionGroup>
  <Accordion title="System Requirements" icon="server">
    ...
    - a supported Python 3 release (recommended)
...
def send_email_with_special_headers():
    ...
    msg['AhaSend-Metadata-Retention'] = '30'
    msg['AhaSend-Data-Retention'] = '7'
...
For framework setup, use [Django](/guides/django) or [Flask](/guides/flask). Python API guides cover [AWS Lambda](/guides/aws-lambda-python), [Azure Functions](/guides/azure-functions-python) and [Cloud Run functions](/guides/google-cloud-functions-python).
