...
<AccordionGroup>
  <Accordion title="Message Metadata & Delivery Log Retention" icon="chart-line">
    **Header:** `ahasend-message-retention`<br />
    **Values:** 1-30 days<br />
  ...
  <Accordion title="Message Data Retention" icon="envelope">
    **Header:** `ahasend-message-data-retention`<br />
    **Values:** 0-30 days<br />
...
<AccordionGroup>
  ...
  <Accordion title="Data Management Headers" icon="database">
    - `ahasend-message-retention`: Number (1-30) - Metadata & delivery log retention in days
    - `ahasend-message-data-retention`: Number (0-30) - Email content retention in days
