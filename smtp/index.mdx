...
<Warning>
**553 email Rejection:** This response is only returned if you enable [Recipient Shields](/security/recipient-shield) in your [Account Settings](https://dash.ahasend.com/account/-/settings).
</Warning>
