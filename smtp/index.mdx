...
All message data is stored in the EU. `send-us.ahasend.com` is a US connection point that accepts SMTP and forwards it to the EU.
...
<CardGroup cols={2}>
  ...
  <Card title="US Server" icon="earth-americas">
    ...
    **Connection point:** Oregon, USA; message data is stored in the EU<br />
...
- **Authentication Method:** AUTH PLAIN only after STARTTLS
