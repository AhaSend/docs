...
This guide shows how to send email through AhaSend API v2, add substitutions, attachments and schedules, and check each recipient result.
...
- [Node.js SDK](/guides/nodejs-sdk), [Go SDK](/guides/go-sdk), [Sandbox mode](/send-api/sandbox).
- [CLI webhook testing](/cli/webhook-testing), [Permission scopes](/api-reference/scopes), [Idempotency](/api-reference/idempotency).
- [API errors](/api-reference/errors), [Rate limits](/api-reference/rate-limits), [Retention rules](/retention).
