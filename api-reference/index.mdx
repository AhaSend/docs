...
<Steps>
  ...
  <Step title="Generate API Key">
    Once logged in, navigate to [the API Keys page](https://dash.ahasend.com/accounts/api-keys) and create a new API key with the appropriate [scopes](/api-reference/scopes) for your use case
  </Step>
