...
Creates and sends a conversational message (with support for CC and BCC) to one or more recipients. This API does not support template substitutions, use [Create Message](/api-reference/messages/create-message) instead if you need substitutions.
