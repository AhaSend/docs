...
<AccordionGroup>
  ...
  <Accordion title="S3-Compatible Storage" icon="database">
    ...
    **Required Credentials:**
    ...
    - Access key and secret key with write and replace permissions (with some providers like Google Cloud Storage, replacing objects requires both write and delete permissions)
  </Accordion>
</AccordionGroup>
...
<Steps>
  <Step title="Create S3 Bucket" icon="bucket">
    **Set up your storage bucket:**
    ...
    2. **Configure permissions** to allow write and replace access for your credentials
  ...
  <Step title="Generate Access Credentials" icon="key">
    **Obtain S3 credentials from your provider:**
    ...
    <Warning>
    **Security:** Use dedicated credentials with minimal permissions. AhaSend requires write and replace permissions to archive messages and update delivery logs.
    </Warning>
    <Info>
...
<AccordionGroup>
  <Accordion title="Connection Issues" icon="plug">
    **Common configuration problems:**
    ...
    - **Bucket permissions:** Ensure write and replace access is granted to your credentials
