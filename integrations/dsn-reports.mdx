---
title: "Delivery Status Notification (DSN) Reports"
sidebarTitle: "DSN Reports"
description: "Have AhaSend email RFC 3464 Delivery Status Notification reports for bounced messages to an address you choose. Available on the Max plan."
icon: "file-medical"
---


AhaSend DSN reports send bounce details to your chosen email address in RFC 3464 format; this guide shows how to configure them.
...
<Steps>
  ...
  <Step title="Configure Domain Overrides (Optional)" icon="globe">
    **Set domain-specific DSN recipients:**
    ...
    2. **Open** the domain and click **Settings**
...
- [Account quickstart](/quickstart), [Domain setup](/domains), [Bounce webhook](/api-reference/webhooks/message-bounced).
- [Webhook setup](/integrations/webhooks), [Plans and limits](/facts), [Tracking setup](/tracking/open-tracking).
