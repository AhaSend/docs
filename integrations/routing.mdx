...
<AccordionGroup>
  ...
  <Accordion title="Message Data Retention" icon="clock">
    **Routing depends on stored message data:**
    - Inbound emails are stored as message data and delivered to your endpoint from that store
    - Message data retention must be **1 day or more** on the account; at 0 days inbound emails are discarded on arrival and nothing is routed
    - Check the setting under **Account Settings → Retention Policy** (see [Data Retention](/retention))
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Emails Not Being Routed" icon="question">
    ...
    **Common Issues:**
    ...
    - Message data retention set to 0 days (see [Data Retention](/retention))
  </Accordion>
