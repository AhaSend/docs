...
- [Install the CLI](/cli/installation), [CLI authentication](/cli/authentication), [Sub-account setup](/scale/sub-accounts).
- [Sub-account API rules](/api-reference/sub-accounts/overview), [Child API keys](/api-reference/sub-accounts/create-sub-account-api-key), [CLI configuration and output](/cli/configuration).
