---
title: "Test Inbound Email Routes Locally with the CLI"
description: "Stream inbound email events to localhost with ahasend routes listen, forward them to your app with signed headers, and trigger test events."
icon: envelopes-bulk
sidebarTitle: "Route Testing"
---
...
# Listen for local-part patterns
...
- [Route payload](/api-reference/routes/route-message), [Route CLI](/cli/commands/routes), [Signature verification](/api-reference/webhooks/security).
