...
description: "Set up OpenID Connect single sign-on for your AhaSend team with Microsoft Entra ID, Google Workspace, Okta, Authentik or Zitadel. Available on the Max plan."
icon: "key-skeleton"
---


AhaSend single sign-on lets your team log in through an OpenID Connect identity provider; this guide walks through its setup.
...
- [Account quickstart](/quickstart), [Two-factor authentication](/security/2fa), [Require team 2FA](/security/2fa-enforcement).
