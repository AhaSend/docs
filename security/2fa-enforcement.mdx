...
description: "As the AhaSend account owner, require every team member to set up two-factor authentication before they can open the dashboard, and see what they experience."
icon: "shield-exclamation"
---


As an AhaSend account owner, you can require two-factor authentication for every team member; this guide explains how to enable enforcement.
...
Enforcement includes the account owner. When OIDC SSO is enabled for the account, enforce MFA at your identity provider; AhaSend skips its own profile-2FA gate for that SSO account. See [SSO configuration](/security/sso).
...
<AccordionGroup>
  ...
  <Accordion title="Compliance Requirements" icon="scale-balanced">
    **Meet security standards:**
    - Helps enforce your team's account-access policy
...
- [Account quickstart](/quickstart), [Set up 2FA first](/security/2fa), [Team members API](/api-reference/accounts/get-account-members).
