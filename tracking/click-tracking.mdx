---
title: "Email Click Tracking: Setup and Link Rules"
sidebarTitle: "Click Tracking"
description: "Track link clicks in AhaSend emails: enable click tracking account-wide or per message, exclude links with data-as-no-track, and fix links that aren't tracked."
icon: "arrow-pointer"
---


AhaSend click tracking records visits to links in your emails; this guide shows how to enable it and read click events.

Available on Free, Pro and Max. See [plans and features](/facts#plans-and-features).

Click tracking is off by default. Enable it in account settings or override it per message. Tracked URLs use the AhaSend tracking domain unless you configure a [custom tracking CNAME](/domains).
...
- [Account quickstart](/quickstart), [Domain setup](/domains), [Click event payload](/api-reference/webhooks/message-clicked).
- [Open tracking](/tracking/open-tracking), [API tracking options](/api-reference/messages/create-message), [SMTP tracking headers](/smtp/special-headers).
