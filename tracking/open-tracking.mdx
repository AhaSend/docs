---
title: "Email Open Tracking: How It Works and Setup"
sidebarTitle: "Open Tracking"
description: "Turn on AhaSend open tracking for the whole account or per message with the ahasend-track-opens header, and see why open rates vary."
icon: "envelope-open"
---


AhaSend open tracking records requests for a tracking image in your emails; this guide explains setup, events and the limits of open data.
...
Open tracking is off by default. Enable it in account settings or override it per message. Tracked URLs use the AhaSend tracking domain unless you configure a [custom tracking CNAME](/domains).
...
<AccordionGroup>
  ...
  <Accordion title="Tracking Pixel Details" icon="image">
    ...
    - **Privacy:** Invisible to recipients: a 1×1 transparent image in the delivered email
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Realistic Expectations" icon="chart-line">
    **Set appropriate expectations:**
    ...
    - Image blocking can prevent an open from being recorded; image prefetching can record an open without a person reading the message
  </Accordion>
...
- [Account quickstart](/quickstart), [Domain setup](/domains), [Open event payload](/api-reference/webhooks/message-opened).
- [Click tracking](/tracking/click-tracking), [API tracking options](/api-reference/messages/create-message), [SMTP tracking headers](/smtp/special-headers).
- [Plans and limits](/facts), [Retention rules](/retention).
