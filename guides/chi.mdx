---
title: "How to Send Transactional Email with Chi (Go)"
sidebarTitle: "Chi"
...
Send your first transactional email from a [chi](https://github.com/go-chi/chi) app in under five minutes using the official AhaSend Go SDK, then wire up webhooks to react to deliveries, bounces, and opens in real time. chi routes plain `net/http` handlers, so everything here is standard library plus the SDK.
