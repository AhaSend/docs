---
title: "How to Add Email to Your App with Claude Code"
sidebarTitle: "Claude Code"
description: "Use Claude Code to build a transactional email workflow on AhaSend: a CLAUDE.md with the real SDK facts, a planned build, and a sandbox test run."
