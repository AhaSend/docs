...
This guide shows how to send transactional email from a Node.js app on Railway with AhaSend, keep credentials on the server, and test a sandbox send.
...
In your local Node.js 22 or newer backend project, run:
