...
Deploying serverless elsewhere too? The same patterns apply on [Vercel](/guides/vercel), and edge runtimes run the same SDK from 0.2.0 onwards: see the [Cloudflare Workers guide](/guides/cloudflare-workers).
