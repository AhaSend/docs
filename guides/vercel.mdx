---
title: "How to Send Email from Vercel Functions"
sidebarTitle: "Vercel"
description: "Send transactional email from Vercel Functions with the AhaSend Node.js SDK: environment variables, sandboxed Preview deployments, and verified webhook routes."
...
This guide shows how to send transactional email from Vercel Functions with AhaSend, keep credentials on the server, and test a sandbox send.
...
The SDK also supports Web APIs in edge runtimes. Check your installed Next.js
version's [runtime documentation](https://nextjs.org/docs/app/api-reference/edge)
before changing a route's runtime.
...
As of September 2026, [Vercel documents a 4.5 MB request and response limit](https://vercel.com/docs/functions/limitations). Check that limit before accepting inbound route events with attachments; the host can reject a request before your verifier runs.
