...
<CardGroup cols={3}>
  ...
  <Card title="Squarespace Domains" icon="globe" href="https://support.squarespace.com/hc/en-us/articles/360002101888-Adding-custom-DNS-records-to-your-Squarespace-managed-domain">
    Add DNS records in Squarespace Domains
  </Card>
