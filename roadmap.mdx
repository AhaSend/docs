...
<p style={{ fontSize: "0.85rem", opacity: 0.7 }}>Last updated 20 August 2026</p>
...
<div className="rm">
  ...
  <section>
    <div className="rm-head">
      <h2 className="rm-badge is-planned">Planned (28)</h2>
    </div>
    <div className="rm-list">
      ...
      <div className="rm-card is-planned">
        <div className="rm-accent" />
        <div>
          <p className="rm-title">Marketing Delivery Tiers and Marketing domains</p>
          <p>Mark a domain as Marketing to send through dedicated marketing delivery tiers and pools.</p>
        </div>
      </div>
      <div className="rm-card is-planned">
        <div className="rm-accent" />
  ...
  <section>
    <div className="rm-head">
      <h2 className="rm-badge is-shipped" id="shipped">Shipped (9)</h2>
    </div>
    <div className="rm-list">
      <div className="rm-card is-shipped">
        ...
        <div>
          ...
          <p>Delivered, deferred, and bounced message webhooks include SMTP outcome details when an attempt was recorded.</p>
