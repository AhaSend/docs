...
<p style={{ fontSize: "0.85rem", opacity: 0.7 }}>Last updated 28 July 2026</p>
...
<div className="rm">
  ...
  <section>
    <div className="rm-head">
      <h2 className="rm-badge is-active">Active (5)</h2>
    </div>
  ...
  <section>
    <div className="rm-head">
      <h2 className="rm-badge is-shipped" id="shipped">Shipped (8)</h2>
    </div>
    <div className="rm-list">
