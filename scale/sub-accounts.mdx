---
title: "Sub-Accounts for SaaS Platforms and Agencies"
sidebarTitle: "Sub-Accounts"
description: "Give each customer an isolated AhaSend sub-account with its own domains, API keys and reputation, under one parent with consolidated billing."
icon: "diagram-subtask"
---


AhaSend sub-accounts give each customer an isolated email account under one parent; this guide covers use cases, setup and billing.
...
See the API overview for [sub-account status values](/api-reference/sub-accounts/overview#sub-account-status).
...
Use parent-account keys with the [sub-account permission scopes](/api-reference/sub-accounts/overview#scopes) needed for each task.
...
- [API authentication](/api-reference/authentication), [Send-only API keys](/send-api/credentials), [Sub-account API rules](/api-reference/sub-accounts/overview).
- [Sub-account CLI](/cli/commands/subaccounts), [Child API keys](/api-reference/sub-accounts/create-sub-account-api-key), [Plans and limits](/facts).
