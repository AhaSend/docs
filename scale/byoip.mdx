---
title: "Bring Your Own IP (BYOIP) for Email Sending"
sidebarTitle: "BYOIP"
description: "Send AhaSend email from IP addresses you own, through a server AhaSend configures. A Max plan add-on; setup takes up to 7 business days."
icon: "server"
---


AhaSend lets you send through your own IP addresses on a VPS; this guide explains the requirements and setup for bringing your own IPs.

Available as a Max add-on. See [plans and features](/facts#plans-and-features).
...
- [Account quickstart](/quickstart), [Dedicated IPs](/scale/dedicated-ips), [IP pools](/scale/ip-pools).
- [Sending guide](/send-api/send-email), [Plans and limits](/facts).
